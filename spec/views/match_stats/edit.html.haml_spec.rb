...
describe "match_stats/edit" do
  before(:each) do
    @match_stat = assign(:match_stat, stub_model(MatchStat,
      :match_id => 1,
      :foulLocal => 1,
      :foulVisitor => 1,
      :offsideLocal => 1,
  ...
  it "renders the edit match_stat form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => match_stats_path(@match_stat), :method => "post" do
